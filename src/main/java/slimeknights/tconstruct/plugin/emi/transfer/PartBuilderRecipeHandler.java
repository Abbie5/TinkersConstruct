...
import slimeknights.tconstruct.plugin.emi.partbuilder.PatternEmiStack;
...
public class PartBuilderRecipeHandler implements StandardRecipeHandler<PartBuilderContainerMenu> {
  ...
  public boolean supportsRecipe(EmiRecipe recipe) {
    return recipe.getCategory() == EMIPlugin.PART_BUILDER_CATEGORY && recipe.supportsRecipeTree();
  }
